        ...
        try:
            ...
            if router == "filesystem":
                ...
                if command == "chmod":
                    ...
                    o = await fs_adapter.chmod(None, None, request_model)
                    r = o.model_dump_json()
                elif command == "chown":
                    request_model = filesystem_models.PutFileChownRequest.model_validate(args["request_model"])
                    o = await fs_adapter.chown(None, None, request_model)
                    r = o.model_dump_json()
                elif command == "file":
                    o = await fs_adapter.file(None, None, **args)
                    r = o.model_dump_json()
                elif command == "stat":
                    o = await fs_adapter.stat(None, None, **args)
                    r = o.model_dump_json()
                elif command == "mkdir":
                    request_model = filesystem_models.PostMakeDirRequest.model_validate(args["request_model"])
                    o = await fs_adapter.mkdir(None, None, request_model)
                    r = o.model_dump_json()
                elif command == "symlink":
                    request_model = filesystem_models.PostFileSymlinkRequest.model_validate(args["request_model"])
                    o = await fs_adapter.symlink(None, None, request_model)
                    r = o.model_dump_json()
                elif command == "ls":
                    o = await fs_adapter.ls(None, None, **args)
                    r = o.model_dump_json()
                elif command == "head":
                    o = await fs_adapter.head(None, None, **args)
                    r = o.model_dump_json()
                elif command == "view":
                    o = await fs_adapter.view(None, None, **args)
                    r = o.model_dump_json()
                elif command == "tail":
                    o = await fs_adapter.tail(None, None, **args)
                    r = o.model_dump_json()
                elif command == "checksum":
                    o = await fs_adapter.checksum(None, None, **args)
                    r = o.model_dump_json()
                elif command == "rm":
                    o = await fs_adapter.rm(None, None, **args)
                    r = o.model_dump_json()
                elif command == "compress":
                    request_model = filesystem_models.PostCompressRequest.model_validate(args["request_model"])
                    o = await fs_adapter.compress(None, None, request_model)
                    r = o.model_dump_json()
                elif command == "extract":
                    request_model = filesystem_models.PostExtractRequest.model_validate(args["request_model"])
                    o = await fs_adapter.extract(None, None, request_model)
                    r = o.model_dump_json()
                elif command == "mv":
                    request_model = filesystem_models.PostMoveRequest.model_validate(args["request_model"])
                    o = await fs_adapter.mv(None, None, request_model)
                    r = o.model_dump_json()
                elif command == "cp":
                    request_model = filesystem_models.PostCopyRequest.model_validate(args["request_model"])
                    o = await fs_adapter.cp(None, None, request_model)
                    r = o.model_dump_json()
                elif command == "download":
                    r = await fs_adapter.download(None, None, **args)
                elif command == "upload":
                    o = await fs_adapter.upload(None, None, **args)
