...
@router.post(
    ...
    responses=DEFAULT_RESPONSES,
    operation_id="chmod",
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["chmod"]])
)
...
@router.post(
    ...
    responses=DEFAULT_RESPONSES,
    operation_id="chown",
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["chown"]])
)
...
@router.post(
    ...
    responses=DEFAULT_RESPONSES,
    operation_id="file",
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["file"]])
)
async def post_file(
    resource_id: str,
...
@router.post(
    ...
    responses=DEFAULT_RESPONSES,
    operation_id="stat",
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["stat"]])
)
async def post_stat(
    resource_id: str,
...
@router.post(
    ...
    responses=DEFAULT_RESPONSES,
    operation_id="mkdir",
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["mkdir"]])
)
...
@router.post(
    ...
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["symlink"]])
)
...
@router.post(
    ...
    responses=DEFAULT_RESPONSES,
    operation_id="ls",
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["ls"]])
)
async def post_ls(
    resource_id: str,
...
@router.post(
    ...
    responses=DEFAULT_RESPONSES,
    operation_id="head",
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["head"]])
)
async def post_head(
    resource_id: str,
...
@router.post(
    ...
    responses=DEFAULT_RESPONSES,
    operation_id="view",
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["view"]])
)
async def post_view(
    resource_id: str,
...
@router.post(
    ...
    responses=DEFAULT_RESPONSES,
    operation_id="tail",
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["tail"]])
)
async def post_tail(
    resource_id: str,
...
@router.post(
    ...
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["checksum"]])
)
...
@router.post(
    ...
    responses=DEFAULT_RESPONSES,
    operation_id="rm",
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["rm"]])
)
async def post_rm(
    resource_id: str,
...
@router.post(
    ...
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["compress"]])
)
...
@router.post(
    ...
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["extract"]])
)
...
@router.post(
    ...
    responses=DEFAULT_RESPONSES,
    operation_id="mv",
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["mv"]])
)
async def post_mv(
    resource_id: str,
    request: Request,
...
@router.post(
    ...
    responses=DEFAULT_RESPONSES,
    operation_id="cp",
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["cp"]])
)
async def post_cp(
    resource_id: str,
    request: Request,
...
@router.post(
    ...
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["download"]])
)
...
@router.post(
    ...
    responses=DEFAULT_RESPONSES,
    operation_id="upload",
    openapi_extra=iri_meta_dict("production", "required", relations=[OPERATION_RELATIONS["upload"]])
)
